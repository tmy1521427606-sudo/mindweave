...
“今天多看”“今天少看”、临时关注和昨日点评都可跳过。今日选择只影响本次生成；昨日点评作为低权重长期信号保存，影响会按 14 天半衰期衰减。生成先筛选昨天的可靠来源，不足 10 条才扩展到最近 7 天，最终保存 10～30 条，通常耗时 3～8 分钟，10 分钟后超时停止。

当日已有内容时：

- “重新生成完整版本”重新筛选并创建一个完整的新版本。
- “只补充新内容”保留当前条目，按来源网址去重后补充新条目。
